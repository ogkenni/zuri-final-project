      ...
      <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
        <div className="col d-flex align-items-start">
          <div className="rounded-circle text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
            <img src={passion} className="bi" width="48px" height="48px" />
          </div>
          <div>
            <h3 className="fs-2 text-body-emphasis">Passion</h3>
            <p>We are devoted to and passionate about our customers.</p>
          </div>
        </div>
        <div className="col d-flex align-items-start">
          <div className="rounded-circle text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
            <img src={innovation} className="bi" width="48px" height="48px" />
          </div>
          <div>
        ...
        <div className="col d-flex align-items-start">
          <div className="rounded-circle text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
            <img src={quality} className="bi" width="48px" height="48px" />
          </div>
          <div>
